...
namespace TicTacToe
{
    ...
    internal class Engine 
    {
        ...
        private List<int> engineMoves = new List<int>();
        ...
        internal static List<int[]> GetAllRiskyCombinationsOfTwo(List<int> engineMoves, List<int> playerMoves) 
        {
        ...
        internal string CalculateMove(Player myPlayer) 
        {
